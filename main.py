...
class DetailViewWindow:  # (0)
    ...
    def create_action_bar(self):  # (4)
        ...
        self.btn_save = tk.Button(action_frame, text="Сохранить", width=15, bg="#2196F3", fg="white", font=("Arial", 10, "bold"), state=tk.DISABLED, command=self.save_data)  # (8)
